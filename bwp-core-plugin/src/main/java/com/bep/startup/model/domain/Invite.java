...
public class Invite extends DomainEntity<Long> {
    ...
    @SequenceGenerator(name = "sqInvite", sequenceName = "SQ_INVITE", initialValue = 1, allocationSize = 1)
    @GeneratedValue(generator = "sqInvite", strategy = GenerationType.SEQUENCE)
    private Long id;
