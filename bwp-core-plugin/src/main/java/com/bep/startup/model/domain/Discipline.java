...
public class Discipline extends DomainEntity<Long> {
    ...
    @SequenceGenerator(name = "sqDiscipline", sequenceName = "SQ_DISCIPLINE", initialValue = 1, allocationSize = 1)
    @GeneratedValue(generator = "sqDiscipline", strategy = GenerationType.SEQUENCE)
    private Long id;
