...
public class ProjectCia extends DomainEntity<Long> {
    ...
    @SequenceGenerator(name = "sqProjectCia", sequenceName = "SQ_PROJECT_CIA", initialValue = 1, allocationSize = 1)
    @GeneratedValue(generator = "sqProjectCia", strategy = GenerationType.SEQUENCE)
    private Long id;
